  ...
  return (
    <div id="projects" className="sm:grid sm:grid-cols-2 sm:gap-9 w-4/5 sm:justify-center mx-auto my-64 pt-32">
      ...
      <div className="flex flex-col w-full">
        <Card pName="My first personal website" pDesc="This project was great, I loved it. It was my first attempt at a personal portfolio site, and my first ever complete website. 
        ...
        <Card pName="Full stack blog app" pDesc="Another Full Stack MOOC project. I used a version of the back end api I had previously made, and added the ability to create comments on blogs.
        ...
        This was my first real Redux project and I think it was a bit too small to benefit from global state management. 
