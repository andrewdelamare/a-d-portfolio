...
export const Projects = () => {
  ...
  return (
    <div id="projects" className="grid grid-cols-2 gap-9 w-4/5 justify-center mx-auto my-64 pt-32">
      ...
      <div className="flex flex-col">
      <Card pName="Full stack challenge" pDesc="SO SOSOSOSOSOSOSOSOOOOOSOOOOOOO much work. What can I say, full stack is a ton of work but dang is it fun. I cant get enough of full stack development. " pUrl="This is a fake url" pTech="HTML, CSS, JS, TS, REACT, Nodejs, REDUX"/>
