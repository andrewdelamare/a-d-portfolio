...
export const Contact = () => {
  ...
  return (
    <div
      className=" md:grid md:grid-cols-2 md:gap-9 mt-64 mb-32 sm:mb-64 pt-32 pb-32 mx-auto w-4/5 text-xl"
      id="contact"
    >
      ...
      <p className="font-serif text-base sm:text-xl self-center text-justify w-9/10">
        I'm always interested in new projects and opportunities, so if you'd
        like to work with me or build something cool with my help please get in
        touch!
      </p>
      <span></span>
