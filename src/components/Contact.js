...
export const Contact = () => {
  ...
  return (
    <div className=" md:grid md:grid-cols-2 md:gap-9 mt-64 mb-32 sm:mb-64 pt-32 pb-32 mx-auto w-4/5 text-xl" id="contact">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-wrap mt-3">
          <a className=" flex font-serif text-base sm:text-lg self-center w-fit p-2 border-black border-4 rounded-xl shadow-xl hover:shadow-lg hover:bg-blue-101 hover:text-white hover:scale-95 active:shadow-md active:scale-90 active:bg-blue-103 duration-100 transition-all ease-in-out" href="mailto:contact@andrewdelamare.com">contact@andrewdelamare.com</a>
          <div className="flex" >
