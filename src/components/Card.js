...
export const Card = ({pName, pUrl, pDesc, pTech}) => {
  ...
  const [pStyles, setPstyles] = useState("flex-row pt-8 font-serif text-base hidden")
  const [lStyles, setLstyles] = useState("flex-row pt-8 font-serif text-base hidden")
  //container styles
  ...
  //p styles
  const pExpanded = "flex pt-8 font-serif text-base fill-slate-900 items-center   "
  const pShrunk = "flex pt-8 font-serif hidden text-base fill-slate-50 items-center"
  //l styles
  const lExpanded = "flex pt-8 fill-slate-900 items-center "
  const lShrunk = "flex pt-8 hidden fill-slate-100 items-center transition ease-in-out"
